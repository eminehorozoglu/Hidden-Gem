...
<form action={handleSubmit} className="flex flex-col items-center gap-4" >
            ...
            <input type="date" name="date" id="date" className="text-amber-800  bg-amber-300" required />
            <label htmlFor="username">User Name:</label>
            <input type="username" name="username" id="username" className="text-amber-800  bg-amber-300"  required/>
            <label htmlFor="comment" >Message :</label>
            <textarea id="comment" name="comment" className="text-amber-800 rounded-xl bg-amber-300" rows="4" cols="40" required/>
