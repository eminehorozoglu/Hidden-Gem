...
return(
    ...
    <Link href={`/comment/${businessId}`}><button className="bg-amber-600 hover:bg-amber-700 text-white font-bold py-2 px-4 rounded-full">comment</button></Link>
    </div>
    <div>
        {
            show===0 && <iframe
        ...
        }
        {
            ...
            <h2 className="text-xl text-amber-700">{data.username} says:</h2>
